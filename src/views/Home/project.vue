<template>
  <div id="projects" class="nk-box bg-dark-1">
    ...
    <div style="margin:0 10%">
      <div v-if="productFrist!==undefined" class="nk-portfolio-list nk-isotope nk-isotope-4-cols" style="width:40%;float:left">
      ...
      <div class="nk-portfolio-list nk-isotope nk-isotope-4-cols" style="width:56%;float:left">
